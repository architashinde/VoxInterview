    ...
    return(
      ...
      <div className="flex flex-row justify-center">
        <h1 className="text-4xl font-semibold">
          ...
          <span className="capitalize">{String(interview.role)}</span> Interview
        </h1>
      </div>
      ...
      <div className="flex flex-row justify-center ">
        <div className="flex flex-row gap-5">
          ...
          <div className="flex flex-row gap-2 items-center">
            ...
            <p>
              ...
              <span className="text-primary-200 font-bold">
                {feedback?.totalScore != null ? String(feedback.totalScore) : "N/A"}
              </span>
              /100
            </p>
          </div>
          ...
          <div className="flex flex-row gap-2">
            ...
            <p>
              {feedback?.createdAt
                ? dayjs(feedback.createdAt as unknown as string).format("MMM D, YYYY h:mm A")
                : "N/A"}
            </p>
          </div>
        </div>
      ...
      <p>{feedback?.finalAssessment != null ? String(feedback.finalAssessment) : ""}</p>
